...
{{site.data.keyword.blockchainfull}} Platform v2.5 provides several avenues for troubleshooting problems and getting support.
{:shortdesc}
...
For issues that are related to {{site.data.keyword.blockchainfull_notm}} Platform v2.5, you can submit a support case from the [mysupport](https://www.ibm.com/support/pages/support-ibm-blockchain-platform-v21x){: external} page.  
