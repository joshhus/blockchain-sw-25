...
{{site.data.keyword.blockchainfull}} Platform 2.1.3 provides several avenues for troubleshooting problems and getting support.
{:shortdesc}
...
For issues that are related to {{site.data.keyword.blockchainfull_notm}} Platform 2.1.3, you can submit a support case from the [mysupport](https://www.ibm.com/support/pages/support-ibm-blockchain-platform-v21x){: external} page.  
