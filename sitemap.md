...
* [Step four: Creating a channel](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-join-network#ibp-console-join-network-create-channel)
  ...
  * [Export your organization information](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-join-network#ibp-console-join-network-add-org2-remote)
...
[{{site.data.keyword.blockchainfull_notm}} Platform getting started videos](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-videos)
...
[Option two: Private data collections on a separate channel](/docs/blockchain-sw-25?topic=blockchain-sw-25-console-icp-about-data-residency#console-icp-about-data-residency-use-case-private-data-channel)
...
[What is the recommended way to manage private keys?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-faq#ibp-v2-faq-hsm)
...
* [Create a new project for your {{site.data.keyword.blockchainfull_notm}} Platform deployment](/docs/blockchain-sw-25?topic=blockchain-sw-25-deploy-ocp#deploy-ocp-project)
...
* [Deploy the {{site.data.keyword.blockchainfull_notm}} Platform console](/docs/blockchain-sw-25?topic=blockchain-sw-25-deploy-ocp-firewall#deploy-ocp-console-fw)
  * [Advanced deployment options](/docs/blockchain-sw-25?topic=blockchain-sw-25-deploy-ocp-firewall#console-deploy-ocp-advanced-firewall)
...
* [Deploy the webhook and custom resource definitions to your OpenShift cluster](/docs/blockchain-sw-25?topic=blockchain-sw-25-deploy-k8#deploy-k8s-webhook-crd)
...
* [Create a secret for your entitlement key](/docs/blockchain-sw-25?topic=blockchain-sw-25-deploy-k8-firewall#deploy-k8-secret-ibpinfra-fw)
...
* [Step three: Deploy the webhook and custom resource definitions to your Kubernetes cluster](/docs/blockchain-sw-25?topic=blockchain-sw-25-upgrade-k8#upgrade-k8s-webhook-crd)
  * [1. Configure role-based access control (RBAC) for the webhook](/docs/blockchain-sw-25?topic=blockchain-sw-25-upgrade-k8#webhook-rbac)
...
* [Installing the 2.5 fix pack behind a firewall](/docs/blockchain-sw-25?topic=blockchain-sw-25-install-fixpack#install-fixpack-firewall)
  * [Before you begin](/docs/blockchain-sw-25?topic=blockchain-sw-25-install-fixpack#install-fixpack-begin-firewall)
...
* [Peer deployment](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-adv-deployment#ibp-console-adv-deployment-peer)
  ...
  * [Customizing a peer configuration](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-adv-deployment#ibp-console-adv-deployment-peer-create-json)
...
[Adding and removing ordering service nodes](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-add-remove-orderer)
...
[Creating and managing identities](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-identities)
...
* [Certificate renewal and expiration](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-identities#ibp-console-identities-expiration)
  * [Automatic certificate renewal](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-identities#ibp-console-identities-cert-renewal)
  * [Manual certificate renewal](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-identities#ibp-console-identities-manual-cert-renewal)
  * [Expired certificates](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-identities#ibp-console-identities-expired-certs)
* [Using the command line to view certificate expiration](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-identities#ibp-console-identities-cli-expiration)
...
* [Updating an organization MSP definition](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-organizations#ibp-console-govern-update-msp)
  * [Adding a new peer or orderer admin certificate](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-organizations#ibp-console-organizations-new-admins)
  * [Adding a new channel admin certificate](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-organizations#ibp-console-organizations-new-admins-existing-channel)
...
* [Step six: Test an instantiated <version2.2.next>deployed</version2.2.next>smart contract](/docs/blockchain-sw-25?topic=blockchain-sw-25-develop-vscode#develop-vscode-testing-instantiated-smart-contract)
...
[Best practices for application development](/docs/blockchain-sw-25?topic=blockchain-sw-25-best-practices-app)
...
* [Example curl request: delete API key](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#console-icp-manage-delete-api-keys-example)

[Managing users using the APIs](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#console-icp-manage-users-apis)
* [List users](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#console-icp-manage-list-users-api)
* [Example curl request: list users](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#console-icp-manage-list-users-api-example)
* [Edit users](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#console-icp-manage-edit-users-api)
* [Example curl request: edit a user](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#console-icp-manage-edit-users-api-example)
* [Add users](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#console-icp-manage-add-users-api)
* [Example curl request: add a user](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#console-icp-manage-add-users-api-example)
* [Remove users](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#console-icp-manage-remove-users-api)
* [Example curl request: remove a user](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#console-icp-remove-add-users-api-example)

[Limitations](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-limitations)

[Building a network by using APIs](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-build-with-apis)
* [Creating a node within a specific zone](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-zone)

[Creating a node with a custom configuration](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-custom)

[Import a network by using APIs](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-import-with-apis)

[Operating your CA with the Fabric CA client](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-config-fabric-ca-client)
* [Set up the Fabric CA client](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-setup-fabric-ca-client)
* [Generate certificates with your CA admin](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-enroll-ca-admin)
* [Registering the component identity with the CA](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-config-register-component)
* [Registering your organization administrator](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-config-register-admin)
* [Generating the admin Membership Service Provider (MSP) folder](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-config-enroll-admin)
* [Registering the component identity with the TLS CA](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-config-register-component-tls)
* [Troubleshooting](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-config-troubleshooting)

[Creating an organization MSP definition](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-msp)

[Creating a configuration file](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-config)
* [Retrieve the CA connection information](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-config-connx-info)
* [Completing the configuration file](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-config-file)
* [Importing an admin identity into the {{site.data.keyword.blockchainfull_notm}} Platform console](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-apis#ibp-v2-apis-admin-console)
...
[Tracking license consumption](/docs/blockchain-sw-25?topic=blockchain-sw-25-metering)

[Overview](/docs/blockchain-sw-25?topic=blockchain-sw-25-metering#metering-overview)

[Manual integration of License Service](/docs/blockchain-sw-25?topic=blockchain-sw-25-metering#metering-manual-integration)

[Archiving license information data before you decommission the cluster](/docs/blockchain-sw-25?topic=blockchain-sw-25-metering#metering-archive)
...
[Glossary](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary)

[Asset](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-asset)

[Block](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-block)

[CA](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-CA)

[Chain](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-chain)

[Chaincode](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-chaincode)

[Channel](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-channel)

[Client](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-client)

[Connection profile](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-connection-profile)

[Consensus](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-consensus)

[Consenter set](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-consenter)

[Console](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-console)

[Consortium](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-consortium)

[CouchDB](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-couchdb)

[Current state](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-current-state)

[Dynamic membership](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-dynamic-memership)

[Endorsement](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-endorsement)

[Endorsement policy](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-endorsement-policy)

[Genesis block](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-genesis-block)

[Gossip](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-gossip)

[HSM](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-hsm)

[Hyperledger Fabric](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-hyperledger-fabric)

[Install](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-install)

[Instantiate](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-instantiate)

[Kafka](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-kafka)

[Ledger](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-ledger)

[LevelDB](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-leveldb)

[Member](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-member)

[MSP](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-msp)

[Network](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-network)

[Network credentials](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-network-credentials)

[Network Monitor](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-network-monitor)

[Node](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-node)

[Ordering node](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-orderer)

[Organization](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-organization)

[Participant](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-participant)

[Peer](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-peer)

[Quorum](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-quorum)

[Raft](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-raft)

[Service credentials](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-service-credentials)

[SDK](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-sdk)

[Shim](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-shim)

[SignCert](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-sign-cert)

[Smart contracts](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-smart-contracts)

[State database](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-state-database)

[Transaction](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-transaction)

[User](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-user)

[World state](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-world-state)
...
* [Fabric peer and ordering node images](/docs/blockchain-sw-25?topic=blockchain-sw-25-release-notes-saas-20#06-18-2020-images)
* [Elimination of Docker daemon dependency](/docs/blockchain-sw-25?topic=blockchain-sw-25-release-notes-saas-20#06-18-2020-docker)
* [Multizone-capable storage](/docs/blockchain-sw-25?topic=blockchain-sw-25-release-notes-saas-20#06-18-2020-Multizone)
* [Kubernetes version upgrade](/docs/blockchain-sw-25?topic=blockchain-sw-25-release-notes-saas-20#06-18-2020-k8s)
...
[Known issues](/docs/blockchain-sw-25?topic=blockchain-sw-25-sw-known-issues)

[Smart contract instantiation timeout](/docs/blockchain-sw-25?topic=blockchain-sw-25-sw-known-issues#sw-known-issues-instantiation-timeout)
...
[Troubleshooting](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting)

[My deployment fails when I try apply the security and access policies to my namespace](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-deployment-policies)

[My deployment fails when I try apply the custom resource definition of the console or operator](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-deployment-cr)

[Extracting the TLS certificate from the Kubernetes webhook fails](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-wh-extract)

[Why are my console actions failing in my Chrome browser Version 77.0.3865.90 (Official Build) (64-bit)?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-chrome-v77)

[Why am I not able to log in to the console from my Chrome browser on Mac OS Catalina?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-console-catalina)

[Why is my channel creation failing or I am unable to add a new organization to my ordering service with the error "Unable to get system channel"?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-accept-tls)

[When I hover over my node, the status is `Status unavailable` or `Status unknown`, what does this mean?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-status-unavailable)

[When I hover over my node, the status is `Status undetectable`, what does this mean?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-status-undetectable)

[Why did my smart contract installation, instantiation or upgrade fail?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-console-smart-contracts-troubleshoot-entry1)

[Why is my Node.js smart contract instantiation failing?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-nodejs-instantiate)

[Why is the smart contract that I installed on the peer not listed in the UI?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-console-build-network-troubleshoot-missing-sc)

[My nodes, channels, smart contracts, and identities have disappeared from the console. How can I get them back?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-browser-storage)

[Why am I getting the error `Unable to authenticate with the enroll ID and secret you provided` when I create a new organization MSP definition?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-create-msp)

[Why am I getting the error `An error occurred when updating channel` when I try to add an organization to my channel?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-update-channel)

[When I log in to my console, why am I getting a 401 Unauthorized error?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-console-401)

[Why am I getting an error “all SubConns are in TransientFailure” on the console?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-console-transientfailure)

[Why is my first invoke of a smart contract returning the following error: no suitable peers available to initialize from?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-smart-contract-anchor-peers)

[Why are my node operations failing after I create my peer or ordering service?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-console-build-network-troubleshoot-entry1)

[Why does my peer or ordering node fail to start?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-console-build-network-troubleshoot-entry2)

[What is the proper way to clean up a failed node deployment?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-cleanup)

[How can I view my smart contract container logs?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-console-smart-contracts-troubleshoot-entry2)

[Why is my CA, peer, or ordering node that is configured to use HSM not working?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-hsm-proxy)

[My CA failed to upgrade, how can I fix it?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-ca-upgrade-fails)

[Why are my transactions returning an endorsement policy error: signature set did not satisfy policy?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-endorsement-sig-failure)

[Why are the transactions I submit from VS Code failing with a No endorsement plan available error?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-anchor-peer)

[Why are the transactions I submit from VS Code failing with an endorsement failure?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-v2-troubleshooting-endorsement)

[How do I delete a peer pod?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-troubleshooting-delete-peer)

[How can I recover a contract after a failed upgrade of the smart contract container?](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-v2-troubleshooting#ibp-troubleshooting-contract-fail)
...
[Getting support](/docs/blockchain-sw-25?topic=blockchain-sw-25-blockchain-support)

[Resources and support forums](/docs/blockchain-sw-25?topic=blockchain-sw-25-blockchain-support#blockchain-support-resources)

[Submitting support cases](/docs/blockchain-sw-25?topic=blockchain-sw-25-blockchain-support#blockchain-support-cases)