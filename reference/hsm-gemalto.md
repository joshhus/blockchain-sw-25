...
{{site.data.keyword.blockchainfull}} Platform 2.5.2 is now available and includes a simpler and faster HSM solution. Upgrade your environment and [configure an HSM client image](/docs/blockchain-sw-252?topic=blockchain-sw-252-ibp-hsm-gemalto) instead of using the PKCS #11 proxy. For upgrade instructions, see upgrading your console and components for [Openshift](/docs/blockchain-sw-252?topic=blockchain-sw-252-upgrade-ocp) or [Kubernetes](/docs/blockchain-sw-252?topic=blockchain-sw-252-upgrade-k8).
{: note}
