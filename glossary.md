...
<div style="background-color: #f4f4f4; padding-left: 20px; border-bottom: 2px solid #0f62fe; padding-top: 12px; padding-bottom: 4px; margin-bottom: 16px;">
  <p style="line-height: 10px;">
    ...
    <a href="https://cloud.ibm.com/docs/blockchain-sw?topic=blockchain-sw-213-glossary">2.1.3</a>
    </p>
</div>
...
See [Member](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-member).
...
See [Chaincode](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-chaincode).
...
See [Current state](/docs/blockchain-sw-25?topic=blockchain-sw-25-glossary#glossary-current-state).
