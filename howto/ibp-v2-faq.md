...
{{site.data.keyword.blockchainfull_notm}} Platform 2.1.3 uses Hyperledger Fabric v1.4.6 while {{site.data.keyword.blockchainfull_notm}} Platform v2.1.0 and 2.1.1 use Hyperledger Fabric 1.4.3.
