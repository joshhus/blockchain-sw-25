...
When I try to deploy the {{site.data.keyword.blockchainfull_notm}} Platform 2.1.3 and apply the Security Context Constraint, clusterRole, or ClusterRoleBinding to my namespace, I encounter one of the following errors.
...
When I try to deploy the {{site.data.keyword.blockchainfull_notm}} Platform 2.1.3 and apply the custom resource definition of the operator or the console, I encounter one of the following errors:
