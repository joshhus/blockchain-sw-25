...
<div style="background-color: #6fdc8c; padding-left: 20px; padding-right: 20px; border-bottom: 4px solid #0f62fe; padding-top: 12px; padding-bottom: 4px; margin-bottom: 16px;">
  <p style="line-height: 20px;">
    ...
    2.5, <a href="/docs/blockchain-sw-251?topic=blockchain-sw-251-ibp-tutorial-extca">2.5.1</a>, 
    <a href="/docs/blockchain-sw-252?topic=blockchain-sw-252-ibp-tutorial-extca">2.5.2 (latest)</a>
    </p>
</div>
...
* [Install the {{site.data.keyword.blockchainfull}} Platform](/docs/blockchain-sw-25?topic=blockchain-sw-25-get-started-console-ocp#get-started-console-ocp-step-two-deploy-console).
