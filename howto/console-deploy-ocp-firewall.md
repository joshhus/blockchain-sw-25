...
<div style="background-color: #6fdc8c; padding-left: 20px; padding-right: 20px; border-bottom: 4px solid #0f62fe; padding-top: 12px; padding-bottom: 4px; margin-bottom: 16px;">
  <p style="line-height: 20px;">
    ...
    <a href="/docs/blockchain-sw-213?topic=blockchain-sw-213-deploy-ocp-firewall">2.1.3</a>, 2.5, 
...
3. You need to install and connect to your cluster by using  to deploy the platform.
...
## Set up the entitlement for your local registry
{: #deploy-ocp-docker-registry-secret-fw}
