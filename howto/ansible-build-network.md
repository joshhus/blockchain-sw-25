...
- Review the topic on [Getting started with Ansible playbooks on the {{site.data.keyword.blockchainfull_notm}} Platform](/docs/blockchain-sw-25?topic=blockchain-sw-25-ansible).
- If you have not already installed the prerequisites locally, install Docker and create the [Docker image](/docs/blockchain-sw-25?topic=blockchain-sw-25-ansible#ansible-docker-build).
