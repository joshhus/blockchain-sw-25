...
- When you are ready to start building smart contracts, you can use the [{{site.data.keyword.blockchainfull_notm}} Visual Studio code extension](/docs/blockchain-sw-25?topic=blockchain-sw-25-blockchain-images) to start building your own smart contract project. You can also use that extension to [connect directly to your network from Visual Studio Code](/docs/blockchain-sw-25?topic=blockchain-sw-25-blockchain-images#develop-vscode-connecting-ibp) and explore the inline tutorials.
...
After you have completed these steps, you can repackage your smart contract using the process that is described in [Packaging smart contracts](/docs/blockchain-sw-25?topic=blockchain-sw-25-blockchain-images#packaging-a-smart-contract).
