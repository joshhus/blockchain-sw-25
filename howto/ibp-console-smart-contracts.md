...
After you have completed these steps, you can repackage your smart contract using the `.tgz` format as described in [Packaging smart contracts](/docs/blockchain-sw-25?topic=blockchain-sw-25-develop-vscode#packaging-a-smart-contract).
