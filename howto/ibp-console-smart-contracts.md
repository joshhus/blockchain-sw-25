...
- <img src="../images/2-x_Pill.png" alt="version 2.x" width="30" style="width:30px; border-style: none"/>*** [Channel application capabilities and peer Fabric images are 2.x](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-smart-contracts-v2)
- <img src="../images/1-4_Pill.png" alt="version 1.4" width="30" style="width:30px; border-style: none"/> [Channel application capabilities and peer Fabric images are 1.4 or 2.x](/docs/blockchain-sw-25?topic=blockchain-sw-25-ibp-console-smart-contracts-v14)
