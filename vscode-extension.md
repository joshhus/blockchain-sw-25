...
![Typical smart contract development workflow](images/SmartContractflow-25.png "Typical smart contract development workflow"){: caption="Figure 1. Typical smart contract development workflow with {{site.data.keyword.blockchainfull_notm}} Platform Developer Tools" caption-side="bottom"}
