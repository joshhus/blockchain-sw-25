...
<div style="background-color: #6fdc8c; padding-left: 20px; padding-right: 20px; border-bottom: 4px solid #0f62fe; padding-top: 12px; padding-bottom: 4px; margin-bottom: 16px;">
  <p style="line-height: 20px;">
    ...
    <a href="/docs/blockchain-sw-213?topic=blockchain-sw-213-develop-vscode">2.1.3</a>, 2.5, 
    <a href="/docs/blockchain-sw-251?topic=blockchain-sw-251-develop-vscode">2.5.1</a>,
    <a href="/docs/blockchain-sw-252?topic=blockchain-sw-252-develop-vscode">2.5.2 (latest)</a>
    </p>
</div>
...
5. Click the **play** button. The extension will automatically package, install, and instantiate or upgrade the smart contract on the local network.
