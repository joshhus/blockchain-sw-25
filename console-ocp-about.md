...
- **Up-to-date Fabric key features**. Leverage the latest features of Hyperledger Fabric <blockchain-sw-213>v1.4.6</blockchain-sw-213>:
...
- **Run Anywhere**. Thanks to the **unified codebase** of the {{site.data.keyword.blockchainfull_notm}} Platform console, <blockchain-sw-213>it is possible to run your components on any Kubernetes v1.14 - v1.16 container platform on x86_64 or s390x.</blockchain-sw-213>
...
- **Scale** up and down the resources in your Kubernetes cluster, paying for only what you need. For more information, see <blockchain-sw-213> [Pricing](/docs/blockchain-sw-213?topic=blockchain-sw-213-ibp-sw-pricing)</blockchain-sw-213>.
