...
# About {{site.data.keyword.blockchainfull_notm}} Platform 2.1.3
{: #console-ocp-about}
...
The {{site.data.keyword.blockchainfull_notm}} Platform 2.1.3 can be deployed with the Kubernetes distributions on the following Platforms:
...
Your {{site.data.keyword.blockchainfull_notm}} Platform 2.1.3 entitlement includes both the full platform and the {{site.data.keyword.blockchainfull_notm}} images.
...
When you are ready to learn how to deploy an instance of the {{site.data.keyword.blockchainfull_notm}} Platform to your Kubernetes cluster see [Getting started with {{site.data.keyword.blockchainfull_notm}} Platform 2.1.3](/docs/blockchain-sw-25?topic=blockchain-sw-25-get-started-console-ocp).
